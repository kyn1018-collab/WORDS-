...
const levelData = {
    1: {
        condition: '반대말을 찾으세요!',
        items: [
            { word: '높다', answer: '낮다', wrongs: ['길다', '크다', '넓다', '작다'] },
            { word: '길다', answer: '짧다', wrongs: ['작다', '많다', '덥다', '무겁다'] },
            { word: '덥다', answer: '춥다', wrongs: ['느리다', '가볍다', '나쁘다', '좁다'] },
            { word: '크다', answer: '작다', wrongs: ['적다', '짧다', '낮다', '어둡다'] },
            { word: '많다', answer: '적다', wrongs: ['작다', '좁다', '느리다', '춥다'] },
            { word: '넓다', answer: '좁다', wrongs: ['짧다', '작다', '가볍다', '나쁘다'] },
            { word: '밝다', answer: '어둡다', wrongs: ['춥다', '낮다', '느리다', '적다'] },
            { word: '무겁다', answer: '가볍다', wrongs: ['좁다', '작다', '짧다', '나쁘다'] },
            { word: '빠르다', answer: '느리다', wrongs: ['적다', '작다', '춥다', '어둡다'] },
            { word: '좋다', answer: '나쁘다', wrongs: ['가볍다', '좁다', '낮다', '적다'] }
        ]
    },
    2: {
        condition: '포함되는 낱말을 찾으세요!',
        items: [
            { word: '가구', answer: '책상', wrongs: ['사과', '바지', '버스', '강아지'] },
            { word: '옷', answer: '바지', wrongs: ['지우개', '의자', '기차', '고양이'] },
            { word: '교통수단', answer: '버스', wrongs: ['연필', '티셔츠', '사자', '포도'] },
            { word: '과일', answer: '사과', wrongs: ['침대', '양말', '비행기', '피아노'] },
            { word: '동물', answer: '강아지', wrongs: ['책상', '바지', '자', '기타'] },
            { word: '학용품', answer: '연필', wrongs: ['의자', '수박', '고양이', '모자'] },
            { word: '악기', answer: '피아노', wrongs: ['사자', '공책', '기차', '바나나'] },
            { word: '색깔', answer: '노랑', wrongs: ['책상', '강아지', '사과', '버스'] },
            { word: '곤충', answer: '나비', wrongs: ['고양이', '포도', '피아노', '양말'] },
            { word: '채소', answer: '당근', wrongs: ['사자', '바지', '연필', '기타'] }
        ]
    }
};
