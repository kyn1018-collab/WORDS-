...
const levelData = {
    ...
    2: {
        ...
        items: [
            { word: '문화재', answer: '숭례문', wrongs: ['경찰서', '백화점', '도서관', '아파트'] },
            { word: '태양계 행성', answer: '목성', wrongs: ['태양', '달', '북극성', '은하수'] },
            { word: '전통문화', answer: '탈춤', wrongs: ['스마트폰', '컴퓨터', '텔레비전', '피자'] },
            { word: '파충류', answer: '거북이', wrongs: ['참새', '고래', '개구리', '강아지'] },
            { word: '관악기', answer: '단소', wrongs: ['피아노', '기타', '장구', '바이올린'] },
            { word: '광물', answer: '다이아몬드', wrongs: ['플라스틱', '유리', '나무', '종이'] },
            { word: '무척추동물', answer: '오징어', wrongs: ['호랑이', '독수리', '고양이', '뱀'] },
            { word: '재생에너지', answer: '태양열', wrongs: ['석탄', '석유', '천연가스', '원자력'] },
            { word: '기상 현상', answer: '천둥', wrongs: ['지진', '화산', '산사태', '해일'] },
            { word: '침엽수', answer: '소나무', wrongs: ['단풍나무', '은행나무', '벚나무', '사과나무'] }
        ]
    }
};
